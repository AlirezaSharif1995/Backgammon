...
public class LoadingUpdate : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        localFilePath = Path.Combine(Application.persistentDataPath, "Resources", fileName);
    ...
    private IEnumerator DownloadCSV()
    {
        ...
        using (UnityWebRequest webRequest = UnityWebRequest.Get(apiUrl))
        {
            ...
            loadPercent = 60;
            infoTextUI.text = "Downloading data";
            ...
            else
            {
                ...
                loadPercent = 80;
                infoTextUI.text = "Download completed";
